    ...
    <>
      <style>{`
        ...
        @keyframes pulse-border {
          ...
          50% { box-shadow: 0 0 0 4px rgba(255,107,157,0.1); }
        }
        @keyframes blink {
          0%, 100% { opacity: 1; }
          50% { opacity: 0; }
        ...
        @keyframes glitch-1 {
          ...
          60% { clip-path: inset(10% 0 75% 0); transform: translate(2px, 0); }
          80% { clip-path: inset(55% 0 20% 0); transform: translate(-4px, 0); }
          100% { clip-path: inset(20% 0 60% 0); transform: translate(0, 0); }
        }
        @keyframes glitch-2 {
          0% { clip-path: inset(60% 0 10% 0); transform: translate(4px, 0); color: #00ffff; }
          30% { clip-path: inset(20% 0 60% 0); transform: translate(-4px, 0); color: #FF6B9D; }
          60% { clip-path: inset(80% 0 5% 0); transform: translate(2px, 0); color: #00ffff; }
        ...
        .input-game:focus {
          ...
          box-shadow: 0 0 0 1px #FF6B9D, 0 0 20px rgba(255,107,157,0.2);
          outline: none;
        }
        .btn-google:hover {
      ...
      >
        ...
        >
          <Link
            href="/"
            className="flex items-center gap-2 font-mono text-[11px] uppercase tracking-widest transition-colors duration-200"
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center px-6 py-12">
          <div className="w-full max-w-sm">
            ...
            <div className="flex items-center gap-3 mb-8">
              <div
                className="px-3 py-1 font-mono text-[9px] uppercase tracking-widest"
                style={{
            ...
            <div className="mb-10">
              ...
              <p className="font-mono text-[11px]" style={{ color: 'rgba(255,255,255,0.25)' }}>
                <span style={{ color: '#FF6B9D' }}>▶</span> 輸入憑證以繼續任務
              ...
              <>
                ...
                <form onSubmit={handleMagicLink} className="flex flex-col gap-3">
                  <div className="relative">
                    <span
                      className="absolute left-3 top-1/2 -translate-y-1/2 font-mono text-[11px]"
                      style={{ color: 'rgba(255,107,157,0.5)' }}
                    >
                      &gt;
                    </span>
                    <input
                  ...
                  >
                    {status === 'loading' ? '[ CONNECTING... ]' : '[ 寄送登入連結 ]'}
                  </button>
                </form>
